...
public final class StringHelper {
     ...
     * results in "Barack Obama is the president of the U, S and A. Barack Obama has a dog."
     * 
     * @param text the text in which to search
     ...
     */
    public static String replaceWithoutRepetition(String text, String find, String replace) {    	
