...
public class StringHelperTest {
    ...
    @Test
    public final void nullOrEmptyShouldWorkAsExpected() {
    ...
    @Test
    public final void joinShouldJoin() {
    ...
    @Test
    public final void replaceShouldWork() {
    ...
    @Test
    public final void numberPrePadding() {
